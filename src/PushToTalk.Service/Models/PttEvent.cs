namespace Olbrasoft.PushToTalk.Service.Models;
...
public enum PttEventType
{
    ...
    /// <summary>Manual mute activated (ScrollLock ON).</summary>
    ManualMuteOn,
    
    /// <summary>Manual mute deactivated (ScrollLock OFF).</summary>
    ManualMuteOff
}
