...
public class TextFilterTests
{
    ...
    {
        // Act
        var filter = new TextFilter(_loggerMock.Object, serviceScopeFactory: null, configPath: null);
    ...
    {
        // Act
        var filter = new TextFilter(_loggerMock.Object, serviceScopeFactory: null, configPath: "");
    ...
    public void Constructor_WithNonExistentPath_ShouldNotThrow()
    {
        ...
        // Act
        var filter = new TextFilter(_loggerMock.Object, serviceScopeFactory: null, configPath: nonExistentPath);
...
public class TextFilterWithConfigTests : IDisposable
{
    ...
    public void Constructor_WithValidConfig_ShouldLoadPatterns()
    {
        ...
        // Act
        var filter = new TextFilter(_loggerMock.Object, serviceScopeFactory: null, configPath: _tempConfigPath);
